...
public class CategoryTestAdd extends Base_Test {

    @DataProvider(name = "categoryData")
    public Object[][] getCategoryData() throws IOException, InvalidFormatException {
        Excel_Util excel = new Excel_Util("src/test/resources/data/AFF_A_Data.xlsx", "AdCategory");
    ...
    public void testCategory(String name, String parent, String describe, String result, String title, String link, String description) throws Exception {
        Extend_Report.startTest("Kiểm tra thêm danh mục - " + description, description);
        ...
        try {
            ...
            for (int i = 1; i < rowCount; i++) {
                ...
                switch (action.toLowerCase()) {
                    ...
                    case "action":
                        ...
                        categoryActions.addCategory(name, parent, describe);
            ...
            String screenshotPath = ScreenShotUtil.captureScreenshot(Driver_Manager.getDriver(), "testCategory_Exception", "CategoryTest");
