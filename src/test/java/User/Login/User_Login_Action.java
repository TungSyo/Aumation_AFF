...
public class User_Login_Action {
	...
	public void enterUsername(String email) {
		basePage.txtUUser.clear();
		basePage.txtUUser.sendKeys(email);
	}

	public void enterPassword(String password) {
		basePage.txtUPass.clear();
		basePage.txtUPass.sendKeys(password);
	}

	public void clickLogin() {
		basePage.btnULogin.click();
	}
	...
	public void clickForgotPassword() {
		basePage.LinkForgotPassword.click();
	}
